...
import net.axel.sharehope.security.domain.dto.user.UserRequestDTO;
...
public interface AppUserMapper extends BaseMapper<AppUser, UserRequestDTO, UserResponseDTO> {
}
